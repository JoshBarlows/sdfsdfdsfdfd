...
local Tab1 = A:T("Farm")
local Tab2 = A:T("Config")
local Tab3 = A:T("Fighting Style")
local Tab4 = A:T("Items Farm")
local Tab5 = A:T("Sea Events")
local Tab6 = A:T("Mirage + RaceV4")
local Tab7 = A:T("Drago Dojo")
...
local Main = Tab1:AddSection("Farm")
local Settings = Tab2:AddSection("Config")
local Melee = Tab3:AddSection("Fighting Style")
local Quests = Tab4:AddSection("Items Farm")
local SeaEvent = Tab5:AddSection("Sea Events")
local Mirage = Tab6:AddSection("Mirage + RaceV4")
local Drago = Tab7:AddSection("Drago Dojo")
