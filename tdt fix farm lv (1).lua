...
local v_1 = game.Players.LocalPlayer

local function v_2(v_3)
    if v_3:FindFirstChild("v_4") then
        v_3.v_4:Destroy()
    end

    local v_4 = Instance.new("Highlight")
    v_4.Name = "v_4"
    v_4.Adornee = v_3
    v_4.Parent = v_3

    v_4.FillColor = Color3.fromRGB(180, 180, 180)
    v_4.FillTransparency = 0.25
    v_4.OutlineColor = Color3.fromRGB(255, 255, 255)
    v_4.OutlineTransparency = 0
end

if v_1.Character then
    v_2(v_1.Character)
end

v_1.CharacterAdded:Connect(function(v_5)
    v_2(v_5)
end)
          ...
          fields = {
            ...
            },
            {
              ...
              value = GetCurrentDateTime() .. " | ".. DispTime(os.time() - StartTime, true)
               .." after execution\nMain task: " .. (  ScriptStorage.Task.StartTDT or "n/a" )  .. " ( " .. (  ScriptStorage.Task[" StartTDT-d"] and  DispTime(os.time() -  ScriptStorage.Task[" StartTDT-d"], true) or "n/a" ) .. " ) \nSub task: " .. (  ScriptStorage.Task.SubTask or "n/a" ) .. " ( " .. (  ScriptStorage.Task["SubTask-d"] and DispTime(os.time() -  ScriptStorage.Task["SubTask-d"], true) or "n/a") .. " )"
            },
            {
              name = "Traceback",
              value = (function() 
...
MainTextLabel = createTextLabel("Status", UDim2.new(0.5, 0, 0.4, 0))
...
function BlurManager:SetIntensity(intensity)
    ...
    tweenService:Create(self.blurFrame, tweenInfo, {
...
function SetText(Name, Text)
    task.spawn(function()
        ...
        local fadeOut = tweenService:Create(TextIns, t1, {
            TextTransparency = 1,
        ...
        local fadeIn = tweenService:Create(TextIns, t1, {
            TextTransparency = 0,
...
local OldExposureCompensation = game.Lighting.ExposureCompensation
    ...
    if isToggleOpen then
        ...
        for _, label in pairs(contentLabels) do
            ...
            if label:FindFirstChildOfClass("UIStroke") then
                ...
                tweenService:Create(label:FindFirstChildOfClass("UIStroke"), tweenInfo, {
                    Transparency = 0
                }):Play()
            end
        end
        ...
        shrinkTween.Completed:Connect(function()
            tweenService:Create(ToggleIcon,
...
ToggleButton.MouseEnter:Connect(function()
    ...
    tweenService:Create(ToggleUIStroke,
        TweenInfo.new(0.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
...
ToggleButton.MouseLeave:Connect(function()
    ...
    tweenService:Create(ToggleUIStroke, tweenInfo, {
...
local function FindNPC(name)
    ...
    local rsNpcFolder = game.ReplicatedStorage:FindFirstChild("NPCs")
    if rsNpcFolder then
        local npc = rsNpcFolder:FindFirstChild(name)
        if npc then return npc end
    end

    warn("NPC not found:", name)
    return nil
end
...
MeleePrices = {
    ["Black Leg"] = {
        ...
        Buy = function()
            _G.BuyingMelee = true
            BuyMeleeTween("BlackLeg", FindNPC("Dark Step Teacher"))
    ...
    ["Electro"] = {
        ...
        Buy = function()
            _G.BuyingMelee = true
            BuyMeleeTween("Electro", FindNPC("Mad Scientist"))
            _G.BuyingMelee = false
        end
    },
    ...
    ["Fishman Karate"] = {
        ...
        Buy = function()
            _G.BuyingMelee = true
            BuyMeleeTween("FishmanKarate", FindNPC("Water Kung-fu Teacher"))
            _G.BuyingMelee = false
        end
    },
...
["Dragon Claw"] = {
    ...
    Buy = function()
        ...
        local npc = FindNPC("Sabi")
        BuyMeleeTween("DragonClaw", npc)
    ...
    ["Superhuman"] = {
        ...
        Buy = function()
            _G.BuyingMelee = true
            BuyMeleeTween("Superhuman", FindNPC("Martial Arts Master"))
            _G.BuyingMelee = false
        end
    },
    ...
    ["Death Step"] = {
        ...
        Buy = function()
            _G.BuyingMelee = true
            BuyMeleeTween("DeathStep", FindNPC("Phoeyu, the Reformed"))
            _G.BuyingMelee = false
        end
    },
    ...
    ["Electric Claw"] = {
        ...
        Buy = function()
            _G.BuyingMelee = true
            BuyMeleeTween("ElectricClaw", FindNPC("Previous Hero"))
            _G.BuyingMelee = false
        end
    },
    ...
    ["Sharkman Karate"] = {
        ...
        Buy = function()
            _G.BuyingMelee = true
            BuyMeleeTween("SharkmanKarate", FindNPC("Sharkman Teacher"))
            _G.BuyingMelee = false
        end
    },
    ...
    ["Dragon Talon"] = {
        ...
        Buy = function()
            _G.BuyingMelee = true
            BuyMeleeTween("DragonTalon", FindNPC("Uzoth"))
            _G.BuyingMelee = false
        end
    },
    ...
    ["Godhuman"] = {
        ...
        Buy = function()
            _G.BuyingMelee = true
            BuyMeleeTween("Godhuman", FindNPC("Ancient Monk"))
            _G.BuyingMelee = false
        end
    }
}
...
function BuyMeleeTween(MeleeName, Npc, IsDragonClaw)
    _G.BuyingMelee = true
    ...
    elseif Npc:FindFirstChild("Head") then
        pos = Npc.Head.Position
    else
        pos = Npc:GetModelCFrame().Position
    end
...
local RawMobRegions = game:HttpGet("https://raw.githubusercontent.com/SkibidiHub111/moblist/refs/heads/main/no1") 
...
function TweenController.Create(Position)
    ...
    if not head:FindFirstChild("RMG") then
        local bodyVelocity = Instance.new("BodyVelocity")
        bodyVelocity.Name = "RMG"
    ...
    return 
        ...
        elseif not NearbyHit then 
            ...
            if (os.time() - LastFound) > 200 then 
                alert("Error while farming, rejoin")
                game:GetService("TeleportService"):Teleport(game.PlaceId)
...
FunctionsHandler.ExpRedeem:RegisterMethod("Start", function() 
    ...
    for Index, Promo in Code do
        ...
        SetTask(" StartTDT", "Code Redemption | " .. Promo .. " | Redeeming...")
        local Response = (Remotes.Redeem:InvokeServer(Promo))
        task.wait() 
        SetTask(" StartTDT", "Code Redemption | " .. Promo .. " | " .. (Response or "Failed"))
        if getsenv(game.ReplicatedStorage.GuideModule)._G.ServerData.ExpBoost == 0 then 
            ...
            if Response and string.find(Response, "SUCC") then 
                return SetTask(" StartTDT", "Code Redemption | X2 Exp Boost Activated!") and task.wait(1)
            end 
            else 
                return  
        end
...
FunctionsHandler.LevelFarm:RegisterMethod("Start", function(Level) 
    ...
    if GodHumanFlag then 
        ...
        if Material then
            if SeaIndex ~= MaterialData[2] then 
                ...
                SetTask(" StartTDT", "Sea Travel | Godhuman Materials | Travelling to Sea " .. MaterialData[2])
                
                Remotes.CommF_:InvokeServer("Travel" .. SeaIndexes[MaterialData[2]]) 
                return 
            end 
            
            SetTask(" StartTDT", "Farming Material For GodHuman " .. Material .. " | In Progress")
    ...
    if os.time() - LastTravel > 60 then 
        ...
        if PlayerLevel >= 1500 and SeaIndex == 2 then 
            ...
            elseif not Services.Workspace.Map.IceCastle.Hall.LibraryDoor:FindFirstChild("PhoeyuDoor") then 
                ...
                SetTask(" StartTDT", "Sea Travel | Teleporting to Third Sea")
            end 
        elseif PlayerLevel >= 700 and SeaIndex == 1 then 
                SetTask(" StartTDT", "Sea Travel | Teleporting to Second Sea")
    ...
    if ScriptStorage.Tools["God's Chalice"] and not ScriptStorage.Tools["Mirror Fractal"] then 
        if (ScriptStorage.Backpack["Conjured Cocoa"] or {Count = 0}).Count < 10 then 
            SetTask(" StartTDT", "Material Farming | Conjured Cocoa | Need 10x | Farming...")
    ...
    if ScriptStorage.Tools["Sweet Chalice"] or ( PlayerLevel == MaxLevel and ( ScriptStorage.Backpack.Bones or {Count = 0}).Count >= 500 ) then 
        ...
        SetTask(" StartTDT", "Fragments Farming | Cake Prince | Dough King")
    ...
    if PlayerLevel >= 2025 and (getsenv(game.ReplicatedStorage.GuideModule)._G.ServerData.ExpBoost == 0 or PlayerLevel == MaxLevel ) and ( ScriptStorage.Backpack.Bones or { Count = 0 } ).Count < 500 then 
        ...
        SetTask(" StartTDT", "Farming Bones get x2 exp")
...
if _G.BuyingMelee then 
    ...
    if Level == 1 then 
        SetTask(" StartTDT", "Farming Level Skip Mode " .. Level)    
    ...
    elseif Level == 4 then
        ...
        if CurrentClaimQuest1 then 
            ...
            SetTask(" StartTDT", "Farming Level " .. MonName .. " | Claiming Quest")
        ...
        SetTask(" StartTDT", "Farming Level" .. MonName .. "Killing Mob...")
    ...
    elseif os.time() - LastestRefreshSenque > 60 then 
        ...
        if Progress == 1 then 
            ...
            for Index, Questplate in Questplates do  
                SetTask(" StartTDT", "Saber Quest Touching " .. Index .. "/5")
        ...
        elseif Progress == 4 then 
            SetTask(" StartTDT", "Saber Quest Getting Information")
            Remotes.CommF_:InvokeServer("ProQuestProgress", "RichSon")
            
            
        elseif Progress == 5 then 
            SetTask(" StartTDT", "Saber Quest Defeating Boss")
            CombatController.Attack("Mob Leader")
            
        elseif Progress == 6 then 
            SetTask(" StartTDT", "Saber Quest Placing at Location")
            Remotes.CommF_:InvokeServer("ProQuestProgress", "RichSon")
            Remotes.CommF_:InvokeServer("ProQuestProgress", "PlaceRelic")
        
        elseif Progress == 7 then 
            SetTask(" StartTDT", "Saber Quest: Getting Saber")
...
FunctionsHandler.SecondSeaPuzzle:RegisterMethod("Start", function() 
    ...
    elseif Progress == 1 then 
        SetTask(" StartTDT", "Auto Second Sea - Talk To Detective")
    ...
    elseif Progress == 2 then 
        ...
        task.wait(1)
        Remotes.CommF_:InvokeServer( "DressrosaQuestProgress", "UseKey")
        SetTask(" StartTDT", "Auto Second Sea - Defeating Ice Admiral")
...
FunctionsHandler.ColosseumPuzzle:RegisterMethod("Start", function() 
    ...
    elseif Progress == 1 then 
        SetTask(" StartTDT", "Auto Bartilo Quest - Defeating 50x Swan Pirate")
    ...
    elseif Progress == 2 then 
        SetTask(" StartTDT", "Auto Bartilo Quest - Defeating Jeremy")
        CombatController.Attack("Jeremy")
    elseif Progress == 3 then 
        SetTask(" StartTDT", "Auto Bartilo Quest - Doing Puzzle")
...
FunctionsHandler.EvoRace:RegisterMethod("Refresh", function() 
    ...
    if not Config.Items.UpV2 then return end 
    if SeaIndex ~= 2 then return end 
...
FunctionsHandler.EvoRace:RegisterMethod("Start", function() 
    ...
    for i = 1,2,1 do 
        ...
        if not Check1 then
            ...
            if Check2 and Check2.Transparency == 0 then 
                ...
                SetTask(" StartTDT", "Auto Race V2 - Collecting Flower " .. i)
    ...
    if not ScriptStorage.Tools["Flower 3"] then 
        SetTask(" StartTDT", "Auto Race V2 - Collecting Flower " .. 3)
        CombatController.Attack("Swan Pirate")
        
    else 
        
        SetTask(" StartTDT", "Auto Race V2 - Idling")
...
FunctionsHandler.BossesTask:RegisterMethod("Refresh", function() 
    ...
    if Boss 
        ...
        and CaculateDistance(Boss.HumanoidRootPart.CFrame) < (SeaIndex == 2 and 3000 or 5000)
    then
        return Boss
    end
end)
...
FunctionsHandler.BossesTask:RegisterMethod("Start", function(Boss) 
    ...
    if Boss then
        SetTask(" StartTDT", "Killing Boss: " .. Boss.Name)
...
if _G.BuyingMelee then 
    ...
    if Boss2 
        and Boss2:FindFirstChild("HumanoidRootPart") 
        and CaculateDistance(Boss2.HumanoidRootPart.CFrame) < (SeaIndex == 2 and 3000 or 5000)
    then
        return Boss2
    end
end)
...
FunctionsHandler.RaidController:RegisterMethod("Start", function()
    ...
    if not CurrentIsland then 
        ...
        SetTask(" StartTDT", "Raid For Fragment..." .. FunctionsHandler.RaidController:Get("CurrentChip")) 
        ...
        SetTask(" StartTDT", "Waiting Raid Start") 
        ...
        if os.time() - RaidStartSenque > 30  then 
            SetTask(" StartTDT", "Raid Not Starting...try again")
        ...
        SetTask(" StartTDT", "Raid (Killing Mob) " .. CurrentIsland.Name .. " / 5")
        local Found = false 
...
if _G.BuyingMelee then 
    ...
    if Fruit then 
        SetTask(" StartTDT", "Collecting Fruit " .. tostring(Fruit)) 
...
if bp:FindFirstChild("Water Key") then
    BuyMeleeTween("SharkmanKarate", FindNPC("Sharkman Teacher"))
end
...
FunctionsHandler.Trevor:RegisterMethod("Start", function() 
    ...
    alert("[ God ]", "Pulling fruit for trevor...")
...
FunctionsHandler.SoulGuitar:RegisterMethod("Refresh", function() 
    ...
    if not Config.Items.SkullGuitar then return end 
    ...
    if not SoulGuitarProcess then  
      Remotes.CommF_:InvokeServer("gravestoneEvent", 2)
        if not CheckFullMoon() then 
            SetTask(" StartTDT", "Hopping for full moon ( soul guitar )") 
...
FunctionsHandler.SoulGuitar:RegisterMethod("Start", function(State) 
    ...
    elseif State == 1 then 
        if SeaIndex ~= 2 then 
            SetTask(" StartTDT", "Teleport to second sea to farm ectoplasm")
            return Remotes.CommF_:InvokeServer("TravelDressrosa")
        else 
            SetTask(" StartTDT", "Farming ectoplasms for soul guitar")
    ...
    elseif State == 2 then 
        ...
        if #Objects < 6 then 
            SetTask(' StartTDT', "Soul Guitar task 1 / 5: waiting until entity spawn") 
            ...
            for Idx, Object in Objects do 
                while task.wait() and Object.Humanoid.Health > 7000 do
                    SetTask(' StartTDT', "Soul Guitar task 1 / 5: Hit mob " .. Idx .. " / 6" ) 
                    FunctionsHandler.LocalPlayerController.Methods.EquipTool:Call("Melee")
            ...
            SetTask(' StartTDT', "Soul Guitar task 1 / 5: Attack") 
    ...
    elseif State == 3 then 
        ...
        while CaculateDistance(CFrame.new(-8800, 178, 6033)) > 10 do
            task.wait()
            SetTask(" StartTDT", "Soul Guitar task 2 / 5: completing placards")
...
FunctionsHandler.CursedDualKatana:RegisterMethod("Refresh", function() 
    ...
    if not Config.Items.GetCdk then return end 
    ...
    if CdkProgess.Opened then 
        for Index, Value in CdkProgess do
            if Index ~= "Opened" and Index ~= "Finished" and Value < 3 then 
                ...
                SetTask(" StartTDT", "Cursed Dual Katana - " .. tostring(ScrollSides[Index]) ..
                            " " .. tostring(Index)
                )
                return false 
            end 
...
Hooks:RegisterNotifyListener("elite", function() 
    ...
    alert("[ No1 ] ", "Elite defeated: ".. tostring(FunctionsHandler.Yama:Get("EliteCount") or "n/a"))
end) 
    ...
    for i = 1, 100, 1 do 
        ...
        for a, b in game.ReplicatedStorage.__ServerBrowser:InvokeServer(i) do
            if a ~= game.JobId and b.Count < (PlayerLimit or 9) then
                ...
                SetTask(" StartTDT", "Hop Server - Joining Server: " .. a .. " Player Count: " .. b.Count .. "/12")
...
spawn(function() 
    ...
    SetText("MainTextLabel", "Our Discord:  discord.gg/FshzCuJ5tV")
    ...
    while task.wait() do
        ...
        if Config.Configuration.HopWhenIdle and LastIdling and os.time() - LastIdling > 60 * 5 then
            SetTask(" StartTDT", "Rejoinjng due idle in 10 min!")
            task.wait(1)
            while task.wait() do
                game:GetService("TeleportService"):Teleport(game.PlaceId)
            end
